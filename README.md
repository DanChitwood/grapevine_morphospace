...
-  The new dataset is titled `NY_and_CA_data.txt`. The code to reproduce the analyses and figures in the revised manuscript is in a Jupyter notebook titled `grapevine_morphospace.ipynb`
